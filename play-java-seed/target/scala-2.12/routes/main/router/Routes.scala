...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """games""", """controllers.HomeController.games(cat:Long ?= 0L)"""),
  ...
  private[this] lazy val controllers_HomeController_games1_invoker = createInvoker(
    HomeController_0.games(fakeValue[Long]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "games",
  ...
  // @LINE:17
  private[this] lazy val controllers_HomeController_employee4_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("employee")))
  )
  private[this] lazy val controllers_HomeController_employee4_invoker = createInvoker(
  ...
  // @LINE:25
  private[this] lazy val controllers_HomeController_addProduct7_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addProduct")))
  )
  private[this] lazy val controllers_HomeController_addProduct7_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_HomeController_games1_route(params@_) =>
      call(params.fromQuery[Long]("cat", Some(0L))) { (cat) =>
        controllers_HomeController_games1_invoker.call(HomeController_0.games(cat))
      }
    ...
    // @LINE:17
    case controllers_HomeController_employee4_route(params@_) =>
      call { 
        controllers_HomeController_employee4_invoker.call(HomeController_0.employee)
      }
    ...
    // @LINE:25
    case controllers_HomeController_addProduct7_route(params@_) =>
      call { 
        controllers_HomeController_addProduct7_invoker.call(HomeController_0.addProduct)
      }
    ...
    case controllers_LoginController_login11_route(params@_) =>
      call { 
        controllers_LoginController_login11_invoker.call(LoginController_1.login)
      }
  
    // @LINE:35
    case controllers_LoginController_loginSubmit12_route(params@_) =>
      call { 
        controllers_LoginController_loginSubmit12_invoker.call(LoginController_1.loginSubmit)
      }
  
    // @LINE:36
    case controllers_LoginController_logout13_route(params@_) =>
      call { 
        controllers_LoginController_logout13_invoker.call(LoginController_1.logout)
      }
  
    // @LINE:38
    case controllers_Assets_versioned14_route(params@_) =>
      call(Param[String]("path", Right("/public")), params.fromPath[Asset]("file", None)) { (path, file) =>
        controllers_Assets_versioned14_invoker.call(Assets_2.versioned(path, file))
      }
  }
}
